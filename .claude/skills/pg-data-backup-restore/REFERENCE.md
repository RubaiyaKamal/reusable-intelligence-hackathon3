# Pg Data Backup Restore - Reference Documentation
...
This skill provides production-ready automation for pg data backup restore.
...
```bash
python scripts/restore_db.sh --config custom.yaml
```
