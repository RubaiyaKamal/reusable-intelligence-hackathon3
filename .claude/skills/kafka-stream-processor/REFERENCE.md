# Kafka Stream Processor - Reference Documentation
...
This skill provides production-ready automation for kafka stream processor.
...
```bash
python scripts/create_processor.py --config custom.yaml
```
