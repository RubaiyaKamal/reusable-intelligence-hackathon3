# Dapr Pubsub Binding - Reference Documentation
...
This skill provides production-ready automation for dapr pubsub binding.
...
```bash
python scripts/create_binding.py --config custom.yaml
```
