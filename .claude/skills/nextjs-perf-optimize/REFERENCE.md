# Nextjs Perf Optimize - Reference Documentation
...
This skill provides production-ready automation for nextjs perf optimize.
...
```bash
python scripts/optimize_images.py --config custom.yaml
```
