# Mcp State Management - Reference Documentation
...
This skill provides production-ready automation for mcp state management.
...
```bash
./scripts/create_state_wrapper.py
```

### Example 2: Custom Configuration
```bash
python scripts/test_state.py --config custom.yaml
```
