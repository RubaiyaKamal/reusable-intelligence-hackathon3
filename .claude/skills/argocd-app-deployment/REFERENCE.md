# Argocd App Deployment - Reference Documentation
...
This skill provides production-ready automation for argocd app deployment.
...
```bash
python scripts/create_application.py --config custom.yaml
```
