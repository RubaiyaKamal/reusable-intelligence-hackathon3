# Docusaurus Search Config - Reference Documentation
...
This skill provides production-ready automation for docusaurus search config.
...
```bash
python scripts/setup_local_search.py --config custom.yaml
```
